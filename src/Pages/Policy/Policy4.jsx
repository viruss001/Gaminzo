...
import {
  FaUnlink,        // No Affiliation Disclaimer
  FaMapMarkedAlt,  // Restricted States
  FaExclamationTriangle, // Limitation of Liability
  FaShieldAlt,     // No Warranty Guarantee
  FaUserShield,    // User Responsibility
  FaTools,         // Right to Rectify Errors
  FaTimesCircle,   // Event & Contest Cancellations
  FaHandshake,     // General Indemnity Clause
  FaServer,        // Force Majeure / Maintenance
  FaBalanceScale,  // Legal Jurisdiction
} from "react-icons/fa";
...
const Disclaimer = ({ theme = "light" }) => {
  ...
  return (
    ...
    >
      {/* Title */}
      <h1 className="text-4xl font-extrabold mb-4 text-center bg-gradient-to-r from-purple-400 to-blue-500 bg-clip-text text-transparent">
        Disclaimer – Gaminzo
      </h1>
      ...
      >
        ...
        <motion.section variants={sectionVariants} initial="hidden" whileInView="show">
          ...
          <p>Gaminzo and its services are provided on an "as-is" and "as-available" basis. The platform does not guarantee that:</p>
          <ul className="list-disc pl-6 space-y-1">
